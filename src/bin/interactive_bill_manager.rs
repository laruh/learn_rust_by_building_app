...
impl Bills {
    ...
    fn get_all(&self) -> Vec<&Bill> {
        ...
        // of the Bills, so we can just collect those directly into a Vector.
...
/// Retrieves user input. This function will automatically retry on io errors,
/// and will return None if the user did not enter any data.
...
/// otherwise will retry until the user enters an amount.
...
mod menu {
    ...
    /// Process for removing an existing bill. Includes accepting user input
    /// and aborting if the user does not enter any data.
